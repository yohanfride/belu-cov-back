...
RumahIsolasi.plugin(autoIncrement.plugin, {
    model: 'rumah_isolasi',
    field: '_id'
});
RumahIsolasi.plugin(uniqueValidator);

RumahIsolasi.statics = {
...
RumahIsolasi.index({ lokasi: '2dsphere' });
var rumah_isolasi = mongoose.model('rumah_isolasi', RumahIsolasi);

/** export schema */
module.exports = {
    RumahIsolasi: rumah_isolasi
};