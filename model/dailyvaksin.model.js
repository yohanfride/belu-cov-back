...
var DailyVaksin = new Schema({
    ...
    terkonfirmasi: Schema.Types.Mixed,
...
DailyVaksin.plugin(autoIncrement.plugin, {
    model: 'daily',
    field: '_id'
});
DailyVaksin.plugin(uniqueValidator);
...
var daily = mongoose.model('daily', DailyVaksin);
