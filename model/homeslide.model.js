...
Homeslide.plugin(autoIncrement.plugin, {
    model: 'homeslide',
    field: '_id'
});
Homeslide.plugin(uniqueValidator);
    ...
    getAll: function(query, callback) {
       if(query.limit){
            ...
            if(query.sort){
                ...
                this.find(query, callback).sort({highlight:-1});    
            }
        }
    },
...
var homeslide = mongoose.model('homeslide', Homeslide);
